...
if (!defined('IRC_SCRAPER_CONFIG')) {
	define('IRC_SCRAPER_CONFIG', nZEDb_CONFIGS . 'ircscraper_settings2.php');
}
...
if (!defined('SCRAPE_IRC_NICKNAME')) {
	exit('ERROR! You must update ircscraper_settings.php using ircscraper_settings_example.php.');
}

if (SCRAPE_IRC_NICKNAME == '') {
	exit("ERROR! You must put a username in ircscraper_settings.php" . PHP_EOL);
}
