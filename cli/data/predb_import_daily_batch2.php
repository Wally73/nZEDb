...
$url         = 'https://api.github.com/repos/Wally73/nZEDbPre_Dumps/contents/dumps/';
...
foreach ($data as $dir => $files) {
	foreach ($files as $file) {
		//var_dump($file);
		if (preg_match("#^https://raw\.githubusercontent\.com/Wally73/nZEDbPre_Dumps/master/dumps/$dir/$filePattern$#",
			$file['download_url'])) {
			...
			if (nZEDb_DEBUG) {
				echo "^https://raw.githubusercontent.com/Wally73/nZEDbPre_Dumps/master/dumps/$dir/$filePattern$\n {$file['download_url']}\n";
			}
		}
	}
}
